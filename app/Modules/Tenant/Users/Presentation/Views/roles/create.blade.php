            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('tenant.settings.users.roles.index') }}">Roles</a>
                        </li>
        ...
        <form action="{{ route('tenant.settings.users.roles.store') }}" method="POST" id="roleForm">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">{{ __('tenant::users.role_name') ?? 'Role Name' }} <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="rolename" class="form-control rounded-3" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">{{ __('tenant::users.reports_to') ?? 'Reports To' }} <span
                                    class="text-danger">*</span></label>
                            <select name="parent_role_id" class="form-select rounded-3" required>
                                @foreach($parentRoles as $pRole)
                                    <option value="{{ $pRole->roleid }}" {{ request('parent_role_id') == $pRole->roleid ? 'selected' : '' }}>
                                        {{ $pRole->rolename }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="assign_type" id="assign_all" value="all" checked>
                        <label class="form-check-label" for="assign_all">
                            <strong>All Users</strong>
                            <small class="d-block text-muted">Users with this role can assign records to any user in the
                                system</small>
                        </label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="assign_type" id="assign_same_subordinate"
                            value="same_or_subordinate">
                        <label class="form-check-label" for="assign_same_subordinate">
                            <strong>Users having Same Role or Subordinate Role</strong>
                            <small class="d-block text-muted">Can assign to users in the same role or any subordinate
                                roles</small>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="assign_type" id="assign_subordinate"
                            value="subordinate">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="privilege_type" id="privilege_direct"
                    ...
                    <div class="form-check mb-4">
                        <input class="form-check-input" type="radio" name="privilege_type" id="privilege_profile"
                            value="profile">
                    ...
                    <div id="directPrivilegesSection" class="privilege-section">
                        <div class="alert alert-info border-0 rounded-3 mb-4">
                            <i class="bi bi-info-circle me-2"></i>
                            You can copy privileges from an existing profile as a starting point, then customize them.
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 14%;">
                                                <div class="d-flex flex-column align-items-center">
                                                    <input type="checkbox"
                                                        class="form-check-input mb-1 select-all-permission"
                                            ...
                                            <th class="text-center" style="width: 14%;"><i class="bi bi-gear me-1"></i>Tools
                                            </th>
                                        </tr>
                                    </thead>
                                                ...
                                                <tr data-module-id="{{ $module->tabid }}">
                                                    ...
                                                    <td class="text-center">
                                                        <input type="checkbox" class="form-check-input permission-checkbox"
                                                            name="privileges[{{ $module->tabid }}][view]" data-permission="view"
                                                            data-module-id="{{ $module->tabid }}" value="1">
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="checkbox" class="form-check-input permission-checkbox"
                                                            name="privileges[{{ $module->tabid }}][create]" data-permission="create"
                                                            data-module-id="{{ $module->tabid }}" value="1">
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="checkbox" class="form-check-input permission-checkbox"
                                                            name="privileges[{{ $module->tabid }}][edit]" data-permission="edit"
                                                            data-module-id="{{ $module->tabid }}" value="1">
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="checkbox" class="form-check-input permission-checkbox"
                                                            name="privileges[{{ $module->tabid }}][delete]" data-permission="delete"
                                                            data-module-id="{{ $module->tabid }}" value="1">
                                                    </td>
                                                    <td class="text-center">
                    ...
                    <div id="profileSelectionSection" class="privilege-section" style="display: none;">
