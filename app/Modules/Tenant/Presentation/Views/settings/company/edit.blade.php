                        ...
                        <div class="card border-0 shadow-sm rounded-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mb-3">
                                    <img id="logoPreview" src="{{ asset('images/logo-placeholder.png') }}" alt="Logo Preview"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('organizationname') is-invalid @enderror"
                                            ...
                                            value="{{ old('organizationname', 'Your Company Name') }}" required>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" id="address"
                                            name="address" rows="2">{{ old('address', '123 Business Street') }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('state') is-invalid @enderror" id="state"
                                            name="state" value="{{ old('state', 'State') }}">
                                        @error('state')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                            name="code" value="{{ old('code', '12345') }}">
                                        @error('code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('country') is-invalid @enderror"
                                            id="country" name="country" value="{{ old('country', 'Country') }}">
                                        @error('country')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                            name="phone" value="{{ old('phone', '+1 234 567 8900') }}">
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" class="form-control @error('fax') is-invalid @enderror" id="fax"
                                            name="fax" value="{{ old('fax', '+1 234 567 8901') }}">
                                        @error('fax')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" class="form-control @error('website') is-invalid @enderror"
                                            id="website" name="website" value="{{ old('website', 'www.example.com') }}">
                                        @error('website')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('vatid') is-invalid @enderror" id="vatid"
                                            name="vatid" value="{{ old('vatid', 'VAT123456789') }}">
                                        @error('vatid')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
