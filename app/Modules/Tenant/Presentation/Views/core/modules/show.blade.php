    ...
    <div class="container-fluid p-0">
        ...
        <div class="overflow-auto mb-4 pb-2">
            <ul class="nav nav-pills gap-2 p-1 bg-white rounded-4 shadow-sm flex-nowrap text-nowrap" id="recordTabs"
                role="tablist" style="width: max-content; min-width: 100%;">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active fw-bold px-4 py-2 rounded-3" id="details-tab" data-bs-toggle="tab"
                ...
                @foreach($relatedLists as $related)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold px-4 py-2 rounded-3" id="rel-{{ $related->relation_id }}-tab"
                            data-bs-toggle="tab" data-bs-target="#rel-{{ $related->relation_id }}" type="button" role="tab">
        ...
        <div class="tab-content" id="recordTabsContent">
            ...
            <!-- Related Lists Tabs -->
            @foreach($relatedLists as $related)
                <div class="tab-pane fade" id="rel-{{ $related->relation_id }}" role="tabpanel">
                    <x-tenant::related-list-specific :module="$metadata" :record-id="$record->crmid" :relation="$related"
