...
enum CustomFieldType: int
{
    ...
    case TEXT_SPECIAL = 2;      // Single line text with special handling
    case AUTOGEN = 4;           // Autogenerated sequence/name
    ...
    case DATE_SYSTEM = 23;      // System date field
    case DATETIME = 6;          // Date and time picker
    case DATETIME_SYSTEM = 70;  // System datetime field
    ...
    case REFERENCE_SYSTEM = 51; // System reference (e.g. Account/User)
    ...
    // System and Special Purpose Types
    case SYSTEM = 255;          // System field
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::DATE, self::DATE_SYSTEM => 'Date',
            self::DATETIME, self::DATETIME_SYSTEM, self::DATETIME_MODIFIED => 'Date & Time',
            ...
            self::REFERENCE, self::REFERENCE_SYSTEM => 'Reference',
            self::OWNER => 'Owner',
            self::OWNER_USER => 'Owner (User)',
            self::AUTOGEN => 'Auto-Generated',
            self::IMAGE => 'Image',
            self::FILE => 'File',
    ...
    {
        return match ($this) {
            self::TEXT, self::TEXT_SPECIAL,
            self::EMAIL, self::PHONE, self::URL, self::SKYPE => 'string',
            self::PICKLIST, self::PICKLIST_READONLY, self::SALUTATION => 'string',
            self::TEXTAREA, self::TEXT_LARGE => 'text',
            self::DATE, self::DATE_SYSTEM => 'date',
            self::DATETIME, self::DATETIME_SYSTEM, self::DATETIME_MODIFIED => 'datetime',
            self::TIME => 'time',
            self::CHECKBOX => 'boolean',
            self::INTEGER, self::REFERENCE, self::REFERENCE_SYSTEM, self::OWNER, self::OWNER_USER => 'integer',
            self::DECIMAL, self::CURRENCY, self::PERCENT => 'decimal',
            self::MULTIPICKLIST => 'text',
            self::IMAGE, self::FILE, self::AUTOGEN => 'string',
            self::CURRENCY_LIST, self::SYSTEM => 'integer',
        };
    }
    ...
    public function getTypeOfData(bool $mandatory = false): string
    {
        ...
        $dataType = match ($this) {
            ...
            self::DATE, self::DATE_SYSTEM => 'D',
            self::DATETIME, self::DATETIME_SYSTEM, self::DATETIME_MODIFIED => 'DT',
            self::TIME => 'T',
            self::CHECKBOX => 'C',
            self::PICKLIST, self::PICKLIST_READONLY,
            self::MULTIPICKLIST, self::SALUTATION => 'V',
            self::REFERENCE, self::REFERENCE_SYSTEM, self::OWNER, self::OWNER_USER => 'V',
            self::IMAGE, self::FILE, self::AUTOGEN => 'V',
            self::CURRENCY_LIST, self::SYSTEM => 'I',
        };
